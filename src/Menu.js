...
class Menu extends Phaser.Scene {
  ...
  create() {
    ...
    // --- LOGO DI TENGAH (WATERMARK) ---
    // Posisi: Tengah Layar (width/2, height/2)
    // Ukuran: 0.5 (Agak besar)
    // Transparansi: 0.2 (Sangat tipis/samar biar tidak tabrakan sama tombol)
    this.add
      .image(this.width / 2, this.height / 2, "logoBaru")
      .setScale(0.5)
      .setAlpha(0.2);
    // ----------------------------------
    ...
    const optionsButton = new CustomButton(
      this,
      this.width / 4,
      this.height / 4,
      "options",
    ...
    const leaderBoardBtn = new CustomButton(
      this,
      (this.width * 3) / 4,
      this.height / 4,
      "leaderBoard",
    ...
    const instructionsBtn = new CustomButton(
      this,
      (this.width * 3) / 4,
      (this.height * 3) / 4,
      "instructions",
    ...
    const creditsBtn = new CustomButton(
      this,
      this.width / 4,
      (this.height * 3) / 4,
      "credits",
