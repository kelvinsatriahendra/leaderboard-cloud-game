...
class Credits extends Phaser.Scene {
  ...
  create() {
    ...
    // --- SAYA MENGHAPUS BARIS 'logo2' DI SINI AGAR KOTAK KECIL HILANG ---

    // Kotak Background Hitam Transparan (Untuk tulisan)
    this.add.rectangle(
      this.width / 2,
      this.height / 2,
      (this.width * 3) / 4,
    ...
    const positionWords = (x, y, message, fillColor, strokeColor) =>
    ...
    const assetsList = positionWords(
      this.width / 2 + 20,
      this.height / 2 + 100,
      "CoolText.com, Kenney.nl,",
      "#ffffff",
      "#0275d8"
    ).setOrigin(0, 0.5);
